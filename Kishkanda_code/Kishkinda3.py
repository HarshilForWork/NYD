...
def convert_csv_to_txt(input_file, output_file):
    ...
    # Drop duplicate rows based on Book, Chapter, and Verse Number (keep first occurrence)
    df = df.drop_duplicates(subset=['Kanda/Book', 'Sarga/Chapter', 'Shloka/Verse Number'], keep='first')
...
if __name__ == "__main__":
    ...
    convert_csv_to_txt('C:/PF/Projects/NYD/Kishkanda_code/Kishkinda_kanda_final.csv', 'output.txt')
